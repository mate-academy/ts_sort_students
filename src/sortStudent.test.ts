  ...
  test(`Function 'sortStudents' should correctly sort array by 'name' in ascending order`, () => {
    expect(sortStudents(students, SortField.Name, 'asc'))
      .toEqual([{
        ...
        name: 'Dale', surname: 'Gandy', age: 20, married: false, grades: [5, 3, 3, 3, 3, 5, 4, 3, 4],
      }, {
        name: 'Diana', surname: 'Dorsey', age: 25, married: false, grades: [3, 3, 4, 5, 4, 3, 5, 5],
      }, {
        name: 'Douglas', surname: 'Paez', age: 22, married: true, grades: [5, 5, 5, 4, 5, 5, 5, 5],
      }, {
        name: 'Glenn', surname: 'Thompson', age: 17, married: false, grades: [5, 5, 5, 5, 5, 5, 5, 5, 4, 4, 3, 2],
      }, {
        name: 'Jessica', surname: 'Buxton', age: 26, married: true, grades: [5, 5, 4, 5, 4, 4, 4, 4, 5, 4, 5, 4],
      }, {
        name: 'Lillian', surname: 'Quinn', age: 19, married: false, grades: [3, 4, 3, 4, 4, 4, 5, 2, 3],
      }, {
        name: 'Pamela', surname: 'Casillas', age: 24, married: false, grades: [4, 5, 4, 5, 5, 4, 3, 2, 3, 3, 3, 2],
      }, {
        name: 'Richard', surname: 'Hall', age: 21, married: false, grades: [3, 2, 4, 5, 4, 3, 3, 3],
      }, {
        name: 'Willie', surname: 'Barrera', age: 18, married: false, grades: [3, 5, 5, 3, 3, 5, 4, 4],
      }]);
  });
