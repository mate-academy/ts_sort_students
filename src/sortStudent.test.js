...
const sortStudents_1 = require("./sortStudents");
const students = [
    {
        name: 'Diana',
        surname: 'Dorsey',
...
describe('Function \'sortStudents\'', () => {
    ...
    test('should correctly sort array by Name in ascending order', () => {
        const sortedData = (0, sortStudents_1.sortStudents)(students, sortStudents_1.SortType.Name, 'asc')
    ...
    test('should correctly sort students by Surname in ascending order', () => {
        const sortedData = (0, sortStudents_1.sortStudents)(students, sortStudents_1.SortType.Surname, 'asc')
            .map((user) => `${user.name} ${user.surname} ${user.age}`);
        expect(sortedData)
            .toEqual([
            'Willie Barrera 22',
    ...
    test('should correctly sort students by Age in descending order', () => {
        const sortedData = (0, sortStudents_1.sortStudents)(students, sortStudents_1.SortType.Age, 'desc')
            .map((user) => `${user.name} ${user.surname} ${user.age}`);
        expect(sortedData)
            .toEqual([
            'Jessica Buxton 26',
    ...
    test('should correctly sort students by Married in descending order', () => {
        const sortedData = (0, sortStudents_1.sortStudents)(students, sortStudents_1.SortType.Married, 'desc')
    ...
    test('should correctly sort students by AverageGrade in descending order', () => {
        const sortedData = (0, sortStudents_1.sortStudents)(students, sortStudents_1.SortType.AverageGrade, 'desc')
    ...
    test('should correctly sort students by AverageGrade in ascending order', () => {
        const sortedData = (0, sortStudents_1.sortStudents)(students, sortStudents_1.SortType.AverageGrade, 'asc')
            .map((user) => `${user.name} ${user.surname} [${user.grades}]`);
        expect(sortedData)
            .toEqual([
            'Richard Hall [3,2,4,5,4,3,3,3]',
